...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getUserBookings(State state, Long userId, int from, int size) {
    ...
    public ResponseEntity<Object> getUserItemBookings(State state, Long userId, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
